...
const examples = [
  { title: "专业匹配", text: "我是首经贸2024级经济学（实验班）专业的学生，我会 Python、Stata 和 R语言", note: "培养方案、职业与技能缺口" },
