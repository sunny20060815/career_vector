...
npm run import:data -- --section curriculum
...
| `major_programs` | 高校培养方案中的学校、届别、专业、课程和能力要求 | 用户提供学校/专业时补充培养路径。 |
| `major_skills` | 由培养方案推断出的代表性技能和依据 | 明确提示它不是用户已掌握技能。 |
| `occupation_catalog` | 《职业大典》职业小类与代表性具体职业 | 解释职业推荐实际包含哪些具体职业。 |
