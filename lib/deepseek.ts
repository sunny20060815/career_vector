...
export function limitCareerAnswer(answer: string, maxLength = 1200): string {
...
【长度与格式】总长度控制在700-1200个汉字之间。允许短标题和项目符号，不使用Markdown表格，不复述JSON或表名。证据缺失的栏目直接说明“当前证据不足”，不得静默省略。结尾给出2-3项具体、低成本、可执行的下一步。`;
