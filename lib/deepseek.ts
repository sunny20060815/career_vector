...
【必答信息】在证据可用时，完整覆盖：1. 最匹配的3-5个职业及匹配技能；2. 当前及预测工资、最低经验和学历结构；3. 当前与预测需求率、每万岗位需求强度及升降方向；4. 推荐城市前5名；5. 职业AI暴露情况，以及技能与AI共同进入岗位要求的强度；6. 已观测技能组合及其市场价值；7. 下一项技能和具体行动建议。有培养方案时，还必须先概括培养目标、核心课程和推断能力，再分别说明“专业基础路径”“个人增强路径”及加入用户确认技能后的变化，并提醒培养方案覆盖不等于用户已经掌握。职业大典明细可用时，说明职业小类包含的代表性具体职业。AI 技能共现强度表示某项技能与 AI 相关技能在同一岗位要求中共同出现的紧密程度，只能解释联系，不能解释因果或薪资溢价。
...
【长度与格式】总长度控制在1200-2200个汉字之间；若课程、职业大典、组合或AI证据齐全，可扩展至3000字以完整覆盖。允许短标题和项目符号，不使用Markdown表格，不复述JSON或表名。证据缺失的栏目直接说明“当前证据不足”，不得静默省略。结尾给出2-3项具体、低成本、可执行的下一步。`;
